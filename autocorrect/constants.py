...
ipfs_paths = {
    ...
    "de": ["QmPRNDmUDTXikq8gWnGcw3ZGmnoBfvekmAyeyX8y6onf23/de.tar.gz"],
...
backup_urls = {
    ...
    "de": [
        "https://www.dropbox.com/scl/fi/l6bkln18mz78k1dd6snve/de.tar.gz?rlkey=s0we8jsltsyrbdqegg59dpc3a&dl=1",
    ],
}
